...
export const SettingsView = React.memo(function SettingsView() {
    ...
    const handleGitHub = async () => {
        const url = 'https://github.com/EngInCoreStudio/AgentsMaestro';
    ...
    const handleReportIssue = async () => {
        const url = 'https://github.com/EngInCoreStudio/AgentsMaestro/issues';
        const supported = await Linking.canOpenURL(url);
        if (supported) {
            await Linking.openURL(url);
        }
        ...
        <ItemList style={{ paddingTop: 0 }}>
            ...
            <ItemGroup title={t('settings.about')} footer={t('settings.aboutFooter')}>
                ...
                <Item
                    ...
                    detail="EngInCoreStudio/AgentsMaestro"
                ...
                <Item
                    ...
                    onPress={async () => {
                        const url = 'https://github.com/EngInCoreStudio/AgentsMaestro/blob/main/TERMS.md';
                        const supported = await Linking.canOpenURL(url);
                        if (supported) {
                            await Linking.openURL(url);
                        }
