...
export const it: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Informazioni',
        aboutFooter: 'AgentsMaestro è un client mobile per Codex e Claude Code. È completamente cifrato end-to-end e il tuo account è memorizzato solo sul tuo dispositivo. Non affiliato con Anthropic.',
        whatsNew: 'Novità',
    ...
    server: {
        ...
        notValidHappyServer: 'Non è un AgentsMaestro Server valido',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID sessione AgentsMaestro copiato negli appunti',
        failedToCopySessionId: 'Impossibile copiare l\'ID sessione AgentsMaestro',
        happySessionId: 'ID sessione AgentsMaestro',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminale richiede di connettersi al tuo account AgentsMaestro. Questo consentirà al terminale di inviare e ricevere messaggi in modo sicuro.',
