...
export const ca: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Quant a',
        aboutFooter: 'AgentsMaestro és un client mòbil de Codex i Claude Code. Tot està xifrat punt a punt i el teu compte es guarda només al teu dispositiu. No està afiliat amb Anthropic.',
        whatsNew: 'Novetats',
    ...
    server: {
        ...
        notValidHappyServer: 'No és un servidor AgentsMaestro vàlid',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID de la sessió d\'AgentsMaestro copiat al porta-retalls',
        failedToCopySessionId: 'Ha fallat copiar l\'ID de la sessió d\'AgentsMaestro',
        happySessionId: 'ID de la sessió d\'AgentsMaestro',
        ...
        happyHome: 'Directori d\'AgentsMaestro',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminal està sol·licitant connectar-se al teu compte d\'AgentsMaestro. Això permetrà al terminal enviar i rebre missatges de forma segura.',
