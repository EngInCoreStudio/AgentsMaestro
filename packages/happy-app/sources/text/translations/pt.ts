...
export const pt: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Sobre',
        aboutFooter: 'AgentsMaestro é um cliente móvel para Codex e Claude Code. É totalmente criptografado ponta a ponta e sua conta é armazenada apenas no seu dispositivo. Não é afiliado à Anthropic.',
        whatsNew: 'Novidades',
    ...
    server: {
        ...
        notValidHappyServer: 'Não é um servidor AgentsMaestro válido',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID da sessão AgentsMaestro copiado para a área de transferência',
        failedToCopySessionId: 'Falha ao copiar ID da sessão AgentsMaestro',
        happySessionId: 'ID da sessão AgentsMaestro',
        ...
        happyHome: 'Diretório AgentsMaestro',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Um terminal está solicitando conexão à sua conta AgentsMaestro. Isso permitirá que o terminal envie e receba mensagens com segurança.',
